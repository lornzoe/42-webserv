...
/*   Updated: 2026/07/14 07:41:53 by lyanga           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static std::vector<std::string> loadFile(char *file)
{
...
static void stripEmptyLines(std::vector<std::string>& lines)
{
	bool single_quotes = false;
	bool double_quotes = false;
...
static std::vector<std::vector<std::string> > generateTokenisedDirectives(const std::vector<std::string>& lines)
{
